      ...
      body:  SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Container(
              padding: EdgeInsets.only(left: 80),
              child: Text("iFolders - Ultimate WordPress & Woo Folder Manager",
                      ...
                      children: [
                        Container(
                          child: Column(
                            children: [
                              Card(
                                child: Image.asset('images/logo.png',height: 300,width: 700,),
                              ),
                              Container(
                                child: Row(
                                  children: [
                              ...
                              Container(
                                ...
                                child: Text("OpenGraphiq allows you to automatically generate social share images for your WordPress content – posts, products and other post-types. It works with every public post-type in WordPress! Now you can automate your creative and social network  management "
                              ...
                              Container(
                                height: 100,
                                width: 700,
                                child: Text("Design your templates to fit your brand with our "
                                    "powerful editor. OpenGraphiq generates share images for all "
                                    "major social networks. They will show up automatically wherever"
                                    " you share an article. These open graph images can either be "
                                    "generated for the entire site or you have ",
                                    style: TextStyle(fontSize: 18,),textAlign: TextAlign.justify,),
                              ),
                              Container(
                                height: 150,
                              ...
                              Container(
                                ...
                                child: ListView.builder(
                                    ...
                                    itemCount: arrFeature.length,
                                    itemBuilder: (BuildContext context, int index) {
                                      return ListTile(
                                          leading: const Icon(Icons.arrow_right_rounded),
                                          title: Text(arrFeature[index]));
                                    }),
                              ),
                              Container(
                                alignment: Alignment.centerLeft,
                                child: Text("Feature",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                              ),
                              Container(
                                height: 300,
                                width: 700,
                              ...
                              Container(
                                ...
                                width: 700,
                                child:   Card(
                                  child: Image.asset('images/imgg.png',fit: BoxFit.cover,),
                                ),
                              ),
                            ],
                          ),
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                // Text('Reguler License',style: TextStyle(fontSize: 20),),
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: ElevatedButton.icon(
                                                    onPressed: () {},
                                                    style: ElevatedButton.styleFrom(
                                                      backgroundColor: Colors.redAccent, // background (button) color// foreground (text) color
                                                    ),
                                                    label: Text("Favorite"),
                                                    icon: Icon(Icons.favorite_border),
                                                  ),
                                    ...
                                    child: Row(
                                      children: [
                                        Container(
                                          child: Column(
                                            children: [
                                              Text('Last Update',style: TextStyle(fontWeight: FontWeight.w900),),
                                              SizedBox(height: 5,),
                                              Text('Published',style: TextStyle(fontWeight: FontWeight.w900),),
                                              SizedBox(height: 5,),
                                              Text('Gutenberg',style: TextStyle(fontWeight: FontWeight.w900),),
                                              SizedBox(height: 20,),
                                              Text('Compatible',style: TextStyle(fontWeight: FontWeight.w900),),
                                              SizedBox(height: 20,),
                                              Text('Compatible With',style: TextStyle(fontWeight: FontWeight.w900),),
                                        ...
                                        Container(
                                          child: Column(
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  TextButton(onPressed: (){}, child:  Text("Chrome")),
                                                  TextButton(onPressed: (){}, child:  Text("Firefox")),
                                                  TextButton(onPressed: (){}, child:  Text("Safari,")),
                                                ],
                                              ),
                                              SizedBox(height: 5,),
                                              TextButton(onPressed: (){}, child:  Text("Yes")),
