              ...
              children: [
                ...
                const Center(
                  child: Text(
                    ...
                    'hand-pick some of the best new code, scripts'
                    'and plugins from our collection.',
                    style: TextStyle(
                      fontSize: 15,
                    ),
                  ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const FeaturedFiles()));
                    },
                    style: ButtonStyle(
...
//allproduct api
  ...
  Future<List<Allproducts>> Allproduct() async {
    ...
    final response = await http.post(
      Uri.parse(
          Apiconst.All_Products+"?device_id=$deviceId&category=1&count=2"),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
    );
